...
export { default as mdiMagnify } from "@mdi/svg/svg/magnify.svg";
export { default as mdiTriangleOutline } from "@mdi/svg/svg/triangle-outline.svg";
export { default as mdiSquareOutline } from "@mdi/svg/svg/square-outline.svg";
